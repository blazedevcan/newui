...
!function ($) {
    ...
    var SpinEdit = function (element, options) {
        ...
        template.find('.icongly-chevron-up').mousehold($.proxy(this.increase, this));
        template.find('.icongly-chevron-down').mousehold($.proxy(this.decrease, this));
    ...
    DRPGlobal.template =
	'<div class="spinedit">' +
	'<i class="icongly-chevron-up"></i>' +
	'<i class="icongly-chevron-down"></i>' +
	'</div>';
